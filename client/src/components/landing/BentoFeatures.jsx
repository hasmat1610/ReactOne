    ...
    <section id="features" className="py-24 relative overflow-hidden bg-[#000000]">
      ...
      <div className="container mx-auto px-4 relative z-10 max-w-7xl">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          <Link to="/auth-flow-code" className="md:col-span-2 group relative rounded-3xl border border-white/5 bg-[#0a0d14] p-8 text-left overflow-hidden transition-all hover:border-[#216be4]/30 flex flex-col justify-between no-underline">
            <div>
          ...
          <Link to="/axios-react" className="col-span-1 group relative rounded-3xl border border-white/5 bg-[#0a0d14] p-8 text-left overflow-hidden transition-all hover:border-[#216be4]/30 flex flex-col justify-between no-underline">
            <div>
              <div className="flex items-center gap-3 mb-4">
                <div className="w-10 h-10 rounded-xl bg-[#216be4]/10 border border-[#216be4]/20 flex items-center justify-center text-[#216be4] shadow-[0_0_15px_rgba(33,107,228,0.2)]">
          ...
          <Link to="/figma-mcp" className="col-span-1 group relative rounded-3xl border border-white/5 bg-[#0a0d14] p-8 text-left overflow-hidden transition-all hover:border-[#216be4]/30 flex flex-col justify-between no-underline">
            <div>
              <div className="flex items-center gap-3 mb-4">
                <div className="w-10 h-10 rounded-xl bg-[#216be4]/10 border border-[#216be4]/20 flex items-center justify-center text-[#216be4] shadow-[0_0_15px_rgba(33,107,228,0.2)]">
          ...
          <div className="col-span-1 group relative rounded-3xl border border-white/5 bg-[#0a0d14] p-8 text-left overflow-hidden transition-all hover:border-[#216be4]/30 flex flex-col items-center justify-center">
            <div className="text-center">
              <div className="w-16 h-16 rounded-2xl bg-gradient-to-br from-[#216be4]/20 to-purple-500/20 border border-[#216be4]/20 flex items-center justify-center mx-auto mb-6">
