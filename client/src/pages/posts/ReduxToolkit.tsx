  ...
  return (
    <div className="min-h-screen bg-[#060913] text-slate-200 font-sans pb-24 selection:bg-purple-500/30">
            ...
            <HeroBanner
                ...
                badgeIcon={Code}
                title="Redux Toolkit"
                subtitle="The official, batteries-included toolset for efficient Redux development."
                date="Mar 06, 2026"
                gradientContainer="from-slate-900 via-purple-900/40 to-[#0a0f18]"
                radialBackground="radial-gradient(circle at 50% 120%, rgba(118, 74, 188, 0.4), transparent 50%), radial-gradient(circle at 10% 20%, rgba(100, 50, 160, 0.3), transparent 30%)"
                badgeContainerStyles="border border-purple-500/30 bg-purple-500/10"
                badgeTextStyles="text-purple-400"
